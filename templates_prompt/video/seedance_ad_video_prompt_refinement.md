...
1. Segment 2 MUST begin with CONTINUE: (NO timestamp prefix). Follow it with an explicit description of the character's pose, hand positions, facial expression, and product placement as shown in `@Image8` (8-LAST).

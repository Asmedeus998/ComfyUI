...
2. Eight sequential keyframe images in a flat array, received as @Image1 through @Image8.
3. The ACTUAL last frame from Segment 1, provided separately as @Image9 (burned-in label: 8-LAST). This frame is the bridge into Segment 2.
...
- Image references: use @ImageN (noun) format with parenthetical disambiguation after EVERY reference, e.g., @Image1 (the character), @Image3 (the product), @Image9 (the continuation frame).

...
link_folder "$HF_BASE/Model/SD1.5"  "$COMFYUI/models/checkpoints" "HF SD1.5 Checkpoints"
link_folder "$HF_BASE/Model/SDXL"   "$COMFYUI/models/checkpoints" "HF SDXL Checkpoints"
link_folder "$HF_BASE/Model/LTX"    "$COMFYUI/models/checkpoints" "HF LTX Checkpoints"
